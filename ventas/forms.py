...
class Venta_Form(forms.ModelForm):
	class Meta:
		model=Venta
		fields=("descuento_cupon","fecha","comision","costo_envio","sub_total","descuento","iva","total","id_medio_venta","id_estatus_venta","link_seguimiento","forma_pago","estatus_envio_producto",)
