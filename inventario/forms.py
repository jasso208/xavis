...
class Productos_Form(forms.ModelForm):
	class Meta:
		model=Productos
		fields=('nombre','precio_ml','porcentaje_ganancia','desc_producto','precio','descuento','id_proveedor','marca','id_estatus','clave_prod_proveedor','precio_proveedor',"publicado_ml",)
