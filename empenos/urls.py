...
from .views import nvo_empeno,alta_cliente,imprime_boleta,consulta_boleta,refrendo,imprime_abono
...
from empenos.apis import api_consulta_cliente,api_limpia_cotizacion,api_consulta_boleta,api_simula_refrendo
app_name="empenos"
