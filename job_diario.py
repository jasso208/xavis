...
r = requests.get(settings.IP_LOCAL + "/empenos/api_backup")
...
r = requests.get(settings.IP_LOCAL + "/empenos/api_job_diario/")
...
#https://empeno.jassdel.com/
r = requests.get(settings.IP_LOCAL + "/empenos/api_notificacion_cajas_abiertas/")
...
#https://empeno.jassdel.com/
r = requests.get(settings.IP_LOCAL + "/empenos/api_guarda_estatus_cartera/")
